        ...
        <div class='col-9'>
            <form action="/produtos/create" method='POST' enctype="multipart/form-data">
                ...
                <div class='form-group'>
                    ...
                    <textarea class="form-control" name="descricao" cols="30" rows="5">{{old("descricao")}}</textarea>
                </div>
                ...
                <div class='form-group'>
                    <label> Peso </label>
                    <input class="form-control" type="number" name='peso_gramas' value='{{old("peso_gramas")}}'>
                </div>
                ...
                <div class='form-group'>
                    <label> Estoque </label>
                    <input class="form-control" type="number" name='estoque' value='{{old("estoque")}}'>
                </div>
